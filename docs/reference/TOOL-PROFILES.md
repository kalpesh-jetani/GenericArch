...
|---|---|
| Design tools and design-reference URLs | Local files, and anything that is the project's own code |
| Mockup and layout references | The repo's own `Scripts/` |
| Ticket trackers and project systems | `git` |
| CI/CD and delivery platforms | The project's own build tools and runtime |
...
platform, or because the value looks obvious. CLAUDE.md §2.4 — building from the name of a
...
CLAUDE.md §3 requires the affected index rows to be edited in the same change as the insertion
...
Read the failure report, never the script body (CLAUDE.md §3).
...
([INSTALL-MANIFEST.md](/docs/reference/INSTALL-MANIFEST.md)(/docs/reference/INSTALL-MANIFEST.md)).
